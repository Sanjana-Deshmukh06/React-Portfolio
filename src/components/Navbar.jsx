  ...
  return (
    <nav className={`${styles.paddingX} w-full flex items-center py-4 fixed top-0 z-20 bg-primary  `}>
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        <ul className='list-none hidden py-2 px-4 sm:flex flex-row gap-10  rounded-full hover:shadow-lg hover:shadow-purple-800 bg-transparent hover:-translate-x-6 transform transition-all duration-200'>
